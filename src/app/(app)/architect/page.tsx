...
export default function ArchitectPage() {
  return (
    <div className="flex flex-col items-center justify-center space-y-6">
      ...
      <Card className="w-full max-w-md card-glow-effect">
        ...
        <CardContent>
          <p className="text-center text-muted-foreground px-4 pb-6">
            Rohan is a passionate developer dedicated to creating tools that empower students and professionals to achieve their dreams.
          </p>
